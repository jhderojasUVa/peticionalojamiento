<body>
    ...
    <div class="collapse navbar-collapse" id="navbar">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="nav-link" href="#" role="link">Resumen</a>
        </li>
        <li class="nav-item">
  ...
  <div class="container h-100">
    <div style="margin: 1em 0em;">
      <h2>Alojamientos <small>que tienes con nosotros</small></h2>
      <div id="alojamientosuser"></div>
      <script type="text/babel" src="<?=base_url()?>js/components/alojamientosuserComponent.js"></script>
    </div>
  </div>
</body>
